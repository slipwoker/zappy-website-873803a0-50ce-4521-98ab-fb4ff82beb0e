document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      const label = field.placeholder || name || 'This field';
      ...
      if (value && field.hasAttribute('maxlength')) {
        ...
        if (value.length > max) {
          showError(field, label + ' must be no more than ' + max + ' characters.');
          return false;
        }
      }
  ...
  const SELECTOR = '.animate-on-scroll, .fade-in, .slide-up, .reveal';
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "CovaLagova uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '873803a0-50ce-4521-98ab-fb4ff82beb0e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '873803a0-50ce-4521-98ab-fb4ff82beb0e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '873803a0-50ce-4521-98ab-fb4ff82beb0e';
